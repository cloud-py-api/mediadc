OC.L10N.register(
    ...
    "Ignore EXIF image orientation" : "Ignorer EXIF-bildeorientering",
    "Enable to allow detection of mirrored images as duplicates" : "Aktiver for å tillate gjenkjenning av speilvendte bilder som duplikater",
    "Task finished alert" : "Oppgave ferdig varsling",
    "Task \"%s\" successfully finished." : "Oppgave \"%s\" ferdig.",
    "Task successfully finished." : "Oppgave ferdig.",
    "_%n file_::_%n files_" : ["%n fil","%n filer"],
    "_Found %n duplicate group_::_Found %n duplicate groups_" : ["Fant %n duplisert gruppe","Fant %n dupliserte grupper"],
    "Task finished with status {status}" : "Oppgave ferdig med status {status}",
    ...
    "Selected group files successfully deleted" : "Valgte gruppefiler ble slettet",
    "Not all selected group files deleted" : "Ikke alle valgte gruppefiler ble slettet",
    "Failed to delete selected group files" : "Sletting av valgte gruppefiler feilet",
    ...
    "Cleanup resolved photos (mark unresolved)" : "Opprydding løste bilder (merk som uløst)",
    "Cleanup resolved videos (mark unresolved)" : "Opprydding løste videoer (merk som uløst)",
    ...
    "Ignore orientation flag successfully updated" : "Ignorer retningsflagget er oppdatert",
    ...
    "Ignore image orientation" : "Ignorer bildeorientering",
    "Remove" : "Fjern",
