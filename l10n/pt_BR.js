OC.L10N.register(
    ...
    "MediaDC installed flag" : "Bandeira de MediaDC instalado",
    "Full path to python interpreter" : "Caminho completo do interpretador Python",
    "Absolute path to the python runnable (e.g. \"/usr/bin/python3\"). Can be obtained by `which python3` command." : "Caminho absoluto do binário do Python (ex. \"/usr/bin/python3\"). Pode ser obtido com o comando `which python3`.",
