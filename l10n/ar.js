OC.L10N.register(
    ...
    "Simultaneously running tasks limit" : "حد عدد المهام التس يتم تشغيلها بشكل متزامن",
    "Maximum number of python background scripts running" : "العدد الأقصى لتشغيل خلفية النص البرمجي بايثون ",
    ...
    "Task finished alert" : "التنبيه عند كتمال المهمة",
    ...
    "MediaDC settings" : "إعدادات ميديا دي سي",
    "Remove" : "حذف",
