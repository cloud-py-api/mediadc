OC.L10N.register(
    ...
    "Absolute path to the python runnable (e.g. \"/usr/bin/python3\"). Can be obtained by `which python3` command." : "Absoluter Pfad der Python Laufzeitumgebung (z. B. \"/usr/bin/python3\"). Kann mit dem `which python3` -Befehl abgerufen werden.",
    ...
    "MediaDC application can be configured only by administration." : "Die MediaDC-Anwendung kann nur von dem Administrator konfiguriert werden",
    "Please contact your cloud administration." : "Bitte kontaktiere deinen Administrator.",
    ...
    "video_required packages can't be installed automatically, this should be done by administrator manually and then recheck installation on this page." : "video_required Pakete können nicht automatisch installiert werden, dies sollte vom Administrator manuell durchgeführt und dann die Installation auf dieser Seite erneut überprüft werden.",
    ...
    "Installation failed. A server error occurred" : "Es ist ein Fehler bei der Installation aufgetreten.",
    ...
    "Package list installation failed. A server error occurred" : "Es ist ein Fehler bei der Installation der Paketlisten-Installation aufgetreten.",
    "Package list successfully deleted" : "Paketliste erfolgreich gelöscht",
    "An error occurred while deleting package list" : "Es ist ein Fehler beim Löschen der Paketliste aufgetreten.",
    "Package list deleting failed. A server error occurred" : "Es ist ein Fehler beim Löschen der Paketliste aufgetreten.",
    ...
    "Packages update failed. A server error occurred" : "Es ist ein Fehler beim Update der Paketliste aufgetreten.",
    ...
    "Some errors occurred while checking installation" : "Es ist ein Fehler beim Überprüfen der Installation aufgetreten.",
    "Packages not installed" : "Pakete nicht installiert",
    "Dependencies checking failed. A server error occurred" : "Es ist ein Fehler beim Prüfen der Abhängigkeiten aufgetreten.",
