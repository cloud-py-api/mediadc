...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/main-admin-settings.js");
/******/ })
/************************************************************************/
/******/ ({
  ...
  var env = {
    "TRANSLATIONS": [{
      ...
      "json": {
        "charset": "utf-8",
        "headers": {
          "Last-Translator": "777 Svyatoi 777 <exmashana67@gmail.com>, 2020",
...
var isObject$1 = function isObject$1(it) {
...
var getMonthNamesShort_1 = getMonthNamesShort; /// <reference types="@nextcloud/typings" />
...
var useSymbolAsUid = nativeSymbol && !Symbol.sham && _typeof2(Symbol.iterator) == 'symbol';
var WellKnownSymbolsStore = shared('wks');
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/index.js?!./src/components/settings/AdminSettings.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./src/components/settings/AdminSettings.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
              ...
              case 0:
                _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])('/apps/mediadc/api/v1/settings')).then(function (res) {
                  ...
                  _this.settings.forEach(function (setting) {
                    _this.mappedSettings[setting.name] = setting;
                  });

                  _this.algorithms = JSON.parse(_this.mappedSettings.installed.value).available_algorithms;
                  _this.hashing_algorithm = JSON.parse(_this.mappedSettings.hashing_algorithm.value);
                  _this.hash_size = _this.mappedSettings.hash_size.value;
                  _this.customExcludeList = JSON.parse(_this.mappedSettings.exclude_list.value).mask;
                  _this.remote_filesize_limit = _this.fromBytesToGBytes(Number(_this.mappedSettings.remote_filesize_limit.value));
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])('/apps/mediadc/api/v1/settings'), {
                  settings: _this2.settings
                }).then(function (res) {
                  _this2.mappedSettings.exclude_list.value = JSON.stringify({
                    mask: _this2.customExcludeList,
                    fileid: []
                  });
                  _this2.updating = false;
                  Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showSuccess"])(t('mediadc', 'Settings successfully updated'));
                }).catch(function (err) {
                  console.debug(err);
                  _this2.updating = false;
                  Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showError"])(t('mediadc', 'Some error occured while updating settings'));
                });
    ...
    truncatePhotosAndVideos: function truncatePhotosAndVideos() {
      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])('/apps/mediadc/api/v1/settings/truncate/all')));
    ...
    updateSetting: function updateSetting(name, setting) {
      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt("return", _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default.a.put(Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])("/apps/mediadc/api/v1/settings/name/".concat(name)), {
                  setting: setting
                }));
    ...
    fromBytesToGBytes: function fromBytesToGBytes(bytes) {
      return bytes / Math.pow(1024, 3);
    },
    fromGBytesToBytes: function fromGBytesToBytes(GBytes) {
      return GBytes * Math.pow(1024, 3);
    },
    updateRemoteFilesizeLimit: function updateRemoteFilesizeLimit() {
      this.mappedSettings.remote_filesize_limit.value = this.fromGBytesToBytes(Number(this.remote_filesize_limit));
    },
    updateHashingAlgorithm: function updateHashingAlgorithm() {
      var _this3 = this;

      if (confirm(t('mediadc', 'The photo and video hashes would be cleaned before changing hashing_algorithm.\nContinue?'))) {
        this.truncatePhotosAndVideos().then(function () {
          _this3.mappedSettings.hashing_algorithm.value = JSON.stringify(_this3.hashing_algorithm);

          _this3.updateSetting(_this3.mappedSettings.hashing_algorithm.name, _this3.mappedSettings.hashing_algorithm).then(function (res) {
            if (res.data.success) {
              Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showSuccess"])(t('mediadc', 'Hashing algorithm successfully updated'));
            } else {
              Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showError"])(res.data.message);
            }
          }).catch(function (err) {
            console.debug(err);
            Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showError"])(t('mediadc', 'Some error occured while updateing setting. Try again'));
          });
        }).catch(function (err) {
          console.debug(err);
          Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showError"])(t('mediadc', 'Some error occured while changing hashing algorithm'));
          _this3.hashing_algorithm = JSON.parse(_this3.mappedSettings.hashing_algorithm.value);
        });
      } else {
        this.hashing_algorithm = JSON.parse(this.mappedSettings.hashing_algorithm.value);
      }
    },
    updateHashSize: function updateHashSize() {
      var _this4 = this;

      if (confirm(t('mediadc', 'The photo and video hashes would be cleaned before changing hash size.\nContinue?'))) {
        this.truncatePhotosAndVideos().then(function () {
          _this4.mappedSettings.hash_size.value = JSON.stringify(_this4.hash_size);

          _this4.updateSetting(_this4.mappedSettings.hash_size.name, _this4.mappedSettings.hash_size).then(function (res) {
            if (res.data.success) {
              Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showSuccess"])(t('mediadc', 'Hash size successfully updated'));
            } else {
              Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showError"])(res.data.message);
            }
          }).catch(function (err) {
    ...
    updateExcludeList: function updateExcludeList() {
      this.mappedSettings.exclude_list.value = JSON.stringify({
        mask: this.customExcludeList,
        fileid: []
      });
      this.updateSetting(this.mappedSettings.exclude_list.name, this.mappedSettings.exclude_list).then(function () {
        Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showSuccess"])(t('mediadc', 'Setting successfully updated'));
      }).catch(function (err) {
        console.debug(err);
        Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showError"])(t('mediadc', 'Some error occured while updating setting. Try again'));
      });
    },
    getConfigurationPageLink: function getConfigurationPageLink() {
      return Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateUrl"])('/apps/mediadc/configuration');
    },
    ...
    addCustomMask: function addCustomMask() {
      ...
      if (this.customExcludeMask.length > 0) {
        if (this.customExcludeList.findIndex(function (mask) {
          ...
          Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showWarning"])(t('mediadc', 'This mask already exists!'));
        }
      } else {
        Object(_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__["showWarning"])(t('mediadc', 'Enter custom mask!'));
      }
    },
    ...
    customExcludeListChanged: function customExcludeListChanged() {
      var _this7 = this;

      if (Array.from(this.customExcludeList).length !== JSON.parse(this.mappedSettings.exclude_list.value).mask.length) {
        return true;
      } else {
        return !Array.from(this.customExcludeList).every(function (value, index) {
          return value === JSON.parse(_this7.mappedSettings.exclude_list.value).mask[index];
        });
      }
    }
  }
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/vue-loader/lib/index.js?!./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css&":
/*!*************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "\n.admin-settings[data-v-7e108296] {\n\tmargin: 20px;\n}\n.setting[data-v-7e108296] {\n\tpadding: 5px 0 10px;\n\tborder-bottom: 1px solid #dadada;\n\tmargin: 10px 0;\n}\nbody.theme--dark .setting[data-v-7e108296],\nbody.theme--dark .block[data-v-7e108296],\nbody.theme--dark .custom-mask[data-v-7e108296] {\n\tborder-color: #262626;\n}\n.setting-description[data-v-7e108296] {\n\tcolor: #666;\n}\n.block[data-v-7e108296] {\n\tmax-width: 100%;\n\theight: 100%;\n\tmax-height: 200px;\n\toverflow-y: scroll;\n\tpadding: 10px 0 10px 10px;\n\tborder-top: 1px solid #dadada;\n\tborder-bottom: 1px solid #dadada;\n}\n.custom-mask[data-v-7e108296] {\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: space-between;\n\tpadding: 5px 0;\n\tborder-bottom: 1px solid #dadada;\n}\n.custom-mask-list[data-v-7e108296] {\n\tdisplay: inline-flex;\n\tflex-direction: column;\n}\n", ""]);
// Exports
...
/***/ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/vue-loader/lib/index.js?!./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css&":
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminSettings_vue_vue_type_style_index_0_id_7e108296_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/vue-loader/lib/index.js?!./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminSettings_vue_vue_type_style_index_0_id_7e108296_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/components/settings/AdminSettings.vue?vue&type=template&id=7e108296&scoped=true&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/components/settings/AdminSettings.vue?vue&type=template&id=7e108296&scoped=true& ***!
  \****************************************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("div", { staticClass: "admin-settings" }, [
    _c("h2", [_vm._v("MediaDC")]),
    _vm._v(" "),
    _vm.settings.length > 0
      ? _c("div", { staticClass: "settings" }, [
          _c("div", { staticClass: "setting" }, [
            _vm.algorithms.length > 0
              ? _c("div", [
                  _c("label", { attrs: { for: "hashing_algorithm" } }, [
                    _vm._v(
                      "\n\t\t\t\t\t" +
                        _vm._s(
                          _vm.mappedSettings.hashing_algorithm.display_name
                        ) +
                        ":\n\t\t\t\t"
                    )
                  ]),
                  ...
                  _c(
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.hashing_algorithm,
                          expression: "hashing_algorithm"
                        }
                      ],
                      attrs: {
                      ...
                      on: {
                        change: [
                          function($event) {
                            ...
                            _vm.hashing_algorithm = $event.target.multiple
                              ? $$selectedVal
                              : $$selectedVal[0]
                          },
                          _vm.updateHashingAlgorithm
                        ]
                      }
                    },
                    _vm._l(_vm.algorithms, function(algorithm) {
                      return _c(
                        "option",
                        { key: algorithm, domProps: { value: algorithm } },
                        [
                          _vm._v(
                            "\n\t\t\t\t\t\t" +
                              _vm._s(algorithm) +
                    ...
                    [
                      _vm._v(
                        "\n\t\t\t\t\t" +
                          _vm._s(
                            _vm.t(
                              "mediadc",
                              "No available algorithms. Configure application dependencies on Configuration page"
                            )
                          ) +
                          "\n\t\t\t\t\t"
                      ),
                      _c(
                        "a",
                        {
                          ...
                          attrs: { href: _vm.getConfigurationPageLink() }
                        },
                        [_c("span", { staticClass: "icon-external" })]
                      )
                    ]
                  )
                ]),
            ...
            _c("p", { staticClass: "setting-description" }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.hashing_algorithm.description) +
                  "\n\t\t\t"
              )
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "setting" }, [
            _c("label", { attrs: { for: "similarity_threshold" } }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.similarity_threshold.display_name) +
                  ":\n\t\t\t"
              )
            ]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.mappedSettings.similarity_threshold.value,
                  expression: "mappedSettings.similarity_threshold.value"
                }
              ],
              attrs: {
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.$set(
                    _vm.mappedSettings.similarity_threshold,
                    "value",
                    $event.target.value
                  )
                }
            ...
            _c("p", { staticClass: "setting-description" }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.similarity_threshold.description) +
                  "\n\t\t\t"
              )
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "setting" }, [
            _c("label", { attrs: { for: "hash_size" } }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.hash_size.display_name) +
                  ":\n\t\t\t"
              )
            ]),
            _vm._v(" "),
            _c(
                ...
                directives: [
                  {
                    ...
                    rawName: "v-model",
                    value: _vm.hash_size,
                    expression: "hash_size"
                  }
                ],
                attrs: { id: "hash_size", name: "hash_size" },
                on: {
                  change: [
                    function($event) {
                      var $$selectedVal = Array.prototype.filter
                      ...
                      _vm.hash_size = $event.target.multiple
                        ? $$selectedVal
                        : $$selectedVal[0]
                    },
                    _vm.updateHashSize
              ...
              [
                ...
                _vm._v(" "),
                _c("option", { domProps: { value: 32 } }, [
                  _vm._v("\n\t\t\t\t\t32\n\t\t\t\t")
                ]),
                _vm._v(" "),
                _c("option", { domProps: { value: 64 } }, [
                  _vm._v("\n\t\t\t\t\t64\n\t\t\t\t")
                ])
              ]
            )
          ...
          _c("div", { staticClass: "setting" }, [
            _c("h3", [
              _vm._v(_vm._s(_vm.mappedSettings.exclude_list.display_name))
            ]),
            _vm._v(" "),
                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.addingCustomMask,
                        expression: "addingCustomMask"
                      }
                    ],
            ...
            _vm._v(" "),
            _vm.customExcludeListChanged()
              ? _c("button", { on: { click: _vm.updateExcludeList } }, [
                  _vm._v(
                    "\n\t\t\t\t" +
                      _vm._s(_vm.t("mediadc", "Save changes")) +
                      "\n\t\t\t"
                  )
                ])
              : _vm._e()
          ...
          _vm._v(" "),
          _c("div", { staticClass: "setting" }, [
            _c("label", { attrs: { for: "python_limit" } }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.python_limit.display_name) +
                  ":\n\t\t\t"
              )
            ]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.mappedSettings.python_limit.value,
                  expression: "mappedSettings.python_limit.value"
                }
              ],
              attrs: {
                id: "python_limit",
              ...
              domProps: { value: _vm.mappedSettings.python_limit.value },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  ...
                  _vm.$set(
                    _vm.mappedSettings.python_limit,
                    "value",
                    $event.target.value
                  )
                }
            ...
            _c("p", { staticClass: "setting-description" }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.python_limit.description) +
                  "\n\t\t\t"
              )
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "setting" }, [
            _c("label", { attrs: { for: "python_command" } }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.python_command.display_name) +
                  ":\n\t\t\t"
              )
            ]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.mappedSettings.python_command.value,
                  expression: "mappedSettings.python_command.value"
                }
              ],
              attrs: {
                id: "python_command",
              ...
              domProps: { value: _vm.mappedSettings.python_command.value },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  ...
                  _vm.$set(
                    _vm.mappedSettings.python_command,
                    "value",
                    $event.target.value
                  )
                }
            ...
            _c("p", { staticClass: "setting-description" }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.python_command.description) +
                  "\n\t\t\t"
              )
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "setting" }, [
            _c("label", { attrs: { for: "remote_filesize_limit" } }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(
                    _vm.mappedSettings.remote_filesize_limit.display_name
                  ) +
                  "\n\t\t\t\t(" +
                  _vm._s(_vm.t("mediadc", "in GBytes")) +
                  "):\n\t\t\t"
              )
            ]),
            _vm._v(" "),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.remote_filesize_limit,
                  expression: "remote_filesize_limit"
                }
              ],
              attrs: {
                id: "remote_filesize_limit",
                type: "number",
                name: "remote_filesize_limit",
                min: "3",
                step: "0.1"
              },
              domProps: { value: _vm.remote_filesize_limit },
              on: {
                input: [
                  function($event) {
                    if ($event.target.composing) {
                    ...
                    _vm.remote_filesize_limit = $event.target.value
                  },
                  _vm.updateRemoteFilesizeLimit
                ]
              }
            }),
            _vm._v(" "),
            _c("p", { staticClass: "setting-description" }, [
              _vm._v(
                "\n\t\t\t\t" +
                  _vm._s(_vm.mappedSettings.remote_filesize_limit.description) +
                  "\n\t\t\t"
              )
            ])
          ]),
          ...
          !_vm.updating
            ...
            : _c("button", { staticStyle: { margin: "10px 0 20px" } }, [
                _c("span", { staticClass: "icon-loading" })
              ])
        ])
      : _c("div", [_c("strong", [_vm._v("Settings list is empty")])])
  ])
}
var staticRenderFns = []
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _AdminSettings_vue_vue_type_template_id_7e108296_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AdminSettings.vue?vue&type=template&id=7e108296&scoped=true& */ "./src/components/settings/AdminSettings.vue?vue&type=template&id=7e108296&scoped=true&");
/* harmony import */ var _AdminSettings_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AdminSettings.vue?vue&type=script&lang=js& */ "./src/components/settings/AdminSettings.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _AdminSettings_vue_vue_type_style_index_0_id_7e108296_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css& */ "./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _AdminSettings_vue_vue_type_template_id_7e108296_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _AdminSettings_vue_vue_type_template_id_7e108296_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "7e108296",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/components/settings/AdminSettings.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./src/components/settings/AdminSettings.vue?vue&type=script&lang=js&":
/*!****************************************************************************!*\
  !*** ./src/components/settings/AdminSettings.vue?vue&type=script&lang=js& ***!
  \****************************************************************************/
/*! exports provided: default */
...
/***/ "./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css&":
/*!************************************************************************************************************!*\
  !*** ./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css& ***!
  \************************************************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminSettings_vue_vue_type_style_index_0_id_7e108296_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/vue-loader/lib/index.js?!./src/components/settings/AdminSettings.vue?vue&type=style&index=0&id=7e108296&scoped=true&lang=css&");
/* empty/unused harmony star reexport */

/***/ }),

/***/ "./src/components/settings/AdminSettings.vue?vue&type=template&id=7e108296&scoped=true&":
/*!**********************************************************************************************!*\
  !*** ./src/components/settings/AdminSettings.vue?vue&type=template&id=7e108296&scoped=true& ***!
  \**********************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminSettings_vue_vue_type_template_id_7e108296_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./AdminSettings.vue?vue&type=template&id=7e108296&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/components/settings/AdminSettings.vue?vue&type=template&id=7e108296&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminSettings_vue_vue_type_template_id_7e108296_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_AdminSettings_vue_vue_type_template_id_7e108296_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./src/main-admin-settings.js":
/*!************************************!*\
  !*** ./src/main-admin-settings.js ***!
  \************************************/
/*! no exports provided */
...
/* harmony import */ var _mixins_Nextcludl10n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mixins/Nextcludl10n */ "./src/mixins/Nextcludl10n.js");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _components_settings_AdminSettings__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/settings/AdminSettings */ "./src/components/settings/AdminSettings.vue");
/**
...
__webpack_require__.nc = btoa(Object(_nextcloud_auth__WEBPACK_IMPORTED_MODULE_1__["getRequestToken"])()); // eslint-disable-next-line

__webpack_require__.p = Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_0__["generateFilePath"])('mediadc', '', 'js/');
vue__WEBPACK_IMPORTED_MODULE_3__["default"].mixin(_mixins_Nextcludl10n__WEBPACK_IMPORTED_MODULE_2__["default"]);
var View = vue__WEBPACK_IMPORTED_MODULE_3__["default"].extend(_components_settings_AdminSettings__WEBPACK_IMPORTED_MODULE_4__["default"]);
new View().$mount('#mediadc-admin-settings');

/***/ }),

/***/ "./src/mixins/Nextcludl10n.js":
/*!************************************!*\
  !*** ./src/mixins/Nextcludl10n.js ***!
  \************************************/
/*! exports provided: default */
...
/******/ });
//# sourceMappingURL=mediadc-settings.js.map?v=b3baa699798bf0b547c7